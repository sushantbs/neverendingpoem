    ...
    return (
      <div>
        ...
        <div className='tab-content-section'>
          <p>If you make a mistake in your submission, there is no way for you to correct it, so try not make any. But if you send me an email at admin@neverendingpoem.com, specifically stating what mistake you made and what correction you want, as well as the page number your lines are on, I will get to it when I can.</p>
